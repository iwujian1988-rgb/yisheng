...
function main() {
  ...
  runNodeEval('AI_DOCUMENT_WORKBENCH', [
    ...
    "for(const text of ['填写字段','补充资料','详细程度','生成设置','预览并生成','下一步：核对并生成','补充整段记录（可选）','templateConfirmSources','编辑正文','让 AI 修改','AI 整理·尚未核对']){if(!wxml.includes(text)) throw new Error('Document workbench missing: '+text);}",
